...
const translations = {
  vi: {
    ...
    topbar: {
      ...
      languageNoResults: "Không tìm thấy ngôn ngữ phù hợp.",
      languageConfirm: "Xác nhận",
      appearance: "Giao diện",
      appearancePicker: "Chọn giao diện",
      appearanceModes: {
        auto: "Tự động",
        light: "Sáng",
        dark: "Tối",
    ...
    songDetail: {
      aria: "Chi tiết bài hát {title}",
      back: "Quay lại trang chủ",
      nowPlaying: "Đang phát",
      track: "Chi tiết bài hát",
      coverAlt: "Ảnh bìa bài hát {title}",
      artist: "Nghệ sĩ",
      category: "Thể loại",
      duration: "Thời lượng",
      unknownCategory: "Chưa phân loại",
      descriptionFallback: "Bài hát đang có trong thư viện MusicWeb.",
      inFavorites: "Đã yêu thích",
      lyrics: "Lời bài hát",
      showLyrics: "Lời bài hát",
      hideLyrics: "Ẩn lời bài hát",
      loadingLyrics: "Đang tìm lời bài hát...",
      lyricsFetchFailed: "Không thể tải lời bài hát lúc này.",
      noLyrics: "Chưa có lời bài hát cho track này.",
    },
    home: {
  ...
  en: {
    ...
    topbar: {
      ...
      languageNoResults: "No matching languages found.",
      languageConfirm: "Confirm",
      appearance: "Appearance",
      appearancePicker: "Choose appearance",
      appearanceModes: {
        auto: "Auto",
        light: "Light",
        dark: "Dark",
    ...
    songDetail: {
      ...
      descriptionFallback: "This song is available in your MusicWeb library.",
      inFavorites: "In favorites",
      lyrics: "Lyrics",
      showLyrics: "Lyrics",
      hideLyrics: "Hide lyrics",
      loadingLyrics: "Looking up lyrics...",
      lyricsFetchFailed: "Could not load lyrics right now.",
      noLyrics: "No lyrics are available for this track.",
    },
    home: {
