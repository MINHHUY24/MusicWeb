    ...
    <footer className="player-bar" aria-label={t("footer.musicPlayer")}>
      ...
      <div className="player-center">
        <div
          ...
          aria-label={t("footer.playbackControls")}
        >
          <button
            className={
              isCurrentSongFavorite
          ...
          <button
            className={
              isShuffleOn ? "icon-button icon-button-active" : "icon-button"
            }
            type="button"
          ...
          <button
            className={
              repeatMode === "off"
                ? "icon-button"
                : "icon-button icon-button-active repeat-button"
            }
            type="button"
      ...
      <div className="player-tools" ref={queueRef}>
        ...
        <button
          className={
            isQueueOpen ? "queue-toggle queue-toggle-active" : "queue-toggle"
          }
          type="button"
        ...
        <aside
          className={
            isQueueOpen ? "queue-panel queue-panel-open" : "queue-panel"
          }
          role="dialog"
          aria-label={t("footer.queue")}
        >
          <div className="queue-panel-heading">
            ...
            <button
              ...
              aria-label={t("footer.closeQueue")}
            >
              {t("common.close")}
            </button>
          </div>
